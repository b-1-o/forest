  ...
  return (
    <div className="site">
      ...
      <header className="nav">
        ...
        <a className="nav-cta" href="https://www.fiverr.com/s/Q27bB5p" target="_blank" rel="noreferrer">
      ...
      <main>
        <section id="home" className="hero">
          ...
          <div className="hero-copy">
            ...
            >
              WEB DEVELOPER / UI / DIGITAL
            </motion.p>
            <motion.h2
              initial={{ opacity: 0, y: 60, filter: 'blur(18px)' }}
              animate={{ opacity: intro ? 0 : 1, y: intro ? 60 : 0, filter: intro ? 'blur(18px)' : 'blur(0px)' }}
            ...
            <motion.button
              ...
              animate={{ opacity: intro ? 0 : 1, y: intro ? 25 : 0 }}
          ...
          <div className="hero-bottom">
            <span>THE DIGITAL FOREST / 01</span>
        ...
        <section id="about" className="immersive-section about-section">
          ...
          <Reveal className="glass-panel about-panel">
            ...
            <div className="panel-tags">
              <span><Layers3 size={14} /> SYSTEMS</span>
              <span><Code2 size={14} /> DEVELOPMENT</span>
              <span><Sparkles size={14} /> MOTION</span>
            </div>
          </Reveal>
        </section>
        ...
        <section id="services" className="immersive-section services-section">
          ...
          <Reveal>
            <div className="section-intro"><span>WHAT I BUILD</span><h3>Useful things, <em>beautifully built.</em></h3></div>
          </Reveal>
        ...
        <section id="stack" className="immersive-section stack-section">
          ...
          <Reveal className="glass-panel stack-panel">
            ...
            <div className="stack-columns">
              {stack.map((column) => (
                <div className="stack-column" key={column.label}>
                  <small>{column.label}</small>
                  {column.items.map((item) => <div className="tech" key={item}><span>{item}</span><Check size={14} /></div>)}
                </div>
              ))}
              <div className="stack-column learning-column">
                <small>CURRENTLY LEARNING</small>
                {learning.map((item) => <div className="tech learning-tech" key={item}><span>{item}</span><i>LEARNING</i></div>)}
              </div>
            </div>
        ...
        <section id="work" className="immersive-section work-section">
          ...
          <div className="project-list">
            {projects.map((project, index) => (
              <Reveal key={project.n} delay={index * 0.08} className="glass-panel project-row">
                <span className="row-number">{project.n}</span>
                <div className="project-main"><small>{project.type}</small><h4>{project.title}</h4><p>{project.text}</p></div>
        ...
        <section id="learning" className="immersive-section learning-section">
          ...
          <Reveal className="learning-layout">
            <div className="glass-panel learning-copy">
              <span>CURRENTLY EXPLORING</span>
              <h3>Still learning.<br /><em>Always building.</em></h3>
              <p>Curiosity is part of the work. I’m exploring lower-level systems, graphics and advanced frontend techniques to understand more of what happens underneath the interface.</p>
            </div>
            <div className="glass-panel learning-list">
              {learning.map((item, index) => <div key={item}><span>0{index + 1}</span><b>{item}</b><ArrowUpRight size={16} /></div>)}
            </div>
          </Reveal>
        </section>

        <section className="principle-section">
          <Reveal className="principle"><span>THE PRINCIPLE</span><h3>Less noise.<br /><em>More signal.</em></h3><p>Every transition has a reason. Every pixel earns its place.</p></Reveal>
        </section>
        ...
        <section id="contact" className="immersive-section contact-section">
          ...
          <Reveal className="glass-panel contact-panel">
            ...
            <h3>Let’s make it <em>feel real.</em></h3>
